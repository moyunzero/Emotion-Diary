...
<circle cx="100" cy="100" r="38" fill="#FDA4AF" stroke="#FB7185" stroke-width="3"/>
<g stroke="#FB7185" stroke-width="5" stroke-linecap="round">
...
<path d="M100 155 L100 95" stroke="#FB7185" stroke-width="6" stroke-linecap="round"/>
<ellipse cx="78" cy="88" rx="28" ry="18" fill="#86EFAC" transform="rotate(-35 78 88)"/>
<ellipse cx="122" cy="88" rx="28" ry="18" fill="#86EFAC" transform="rotate(35 122 88)"/>
<ellipse cx="100" cy="72" rx="22" ry="14" fill="#A7F3D0" transform="rotate(0 100 72)"/>
</svg>`);
...
<path d="M55 118 C 45 118 38 110 40 100 C 38 88 48 78 60 78 C 62 62 78 50 96 52 C 108 38 132 42 142 58 C 158 56 172 72 170 88 C 172 104 158 118 140 118 Z" fill="#FFFFFF" stroke="#C084FC" stroke-width="3"/>
<circle cx="72" cy="138" r="6" fill="#A78BFA" opacity="0.85"/>
<circle cx="100" cy="148" r="6" fill="#A78BFA" opacity="0.85"/>
<circle cx="128" cy="138" r="6" fill="#A78BFA" opacity="0.85"/>
</svg>`);
...
<path d="M100 52 L108 78 L136 78 L114 94 L122 120 L100 104 L78 120 L86 94 L64 78 L92 78 Z" fill="#FECDD3" stroke="#A78BFA" stroke-width="2"/>
