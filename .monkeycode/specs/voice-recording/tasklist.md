...
- [x] 5.2.2 文件保存失败处理
- [x] 5.2.3 上传失败重试（最多3次）
- [x] 5.2.4 播放失败降级（remoteUrl 在线播放）

#### 5.3 体验优化

- [x] 5.3.1 录音草稿保存与恢复
- [x] 5.3.2 低性能设备波形降级（WaveformView 支持 simple-bars 降级模式）
...
- [x] 6.1.1 AudioData 类型测试
- [x] 6.1.2 computeEntrySyncStatus 函数测试
- [x] 6.1.3 录音状态机测试
- [x] 6.1.4 播放控制测试

#### 6.2 集成测试

- [x] 6.2.1 Record 页面录音流程测试
- [x] 6.2.2 Entry 保存与加载测试（含音频）
- [x] 6.2.3 同步测试（离线上传、下载）
