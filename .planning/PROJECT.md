...
- [ ] **回顾导出（图片优先）**：用户可选 **周/月** 时间范围，一键生成 **可保存到相册的图片**（PDF 明确后置）；版式须包含下列区块（见下节「导出版式契约」）。
...
---
*Last updated: 2026-03-21 after Phase 05 completion（IOS-01 traceability closed, App Store submission assets aligned）*
